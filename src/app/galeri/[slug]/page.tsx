...
export default async function StoryPage({ params }: Props) {
  ...
  return <main>
    ...
    <section className="experience-section living-section"><LivingBackdrop tone="light" variant="story" /><div className="wrap"><StoryExperience story={story} pageCount={book.pageCount} cues={book.cues} /></div></section>
