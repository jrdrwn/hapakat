...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return pageMetadata(`/galeri/${story.slug}`, story.title, `Tonton ${story.title}, dengarkan audionya, dan baca buku PDF berbahasa ${story.language}.`, `/media/social/${story.slug}.jpg`);
}
...
export default async function StoryPage({ params }: Props) {
  ...
  return <main>
    <section className="story-detail-hero section-with-motif"><LivingBackdrop variant="story" /><CulturalMotif side="right" light pattern="woven" /><div className="wrap">
    ...
    <section className="experience-section living-section"><LivingBackdrop tone="light" variant="story" /><div className="wrap"><StoryExperience key={story.slug} story={story} pageCount={book.pageCount} cues={book.cues} /></div></section>
