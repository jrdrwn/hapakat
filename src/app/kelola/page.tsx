...
export const metadata: Metadata = { title: "Pengelolaan" };
...
export default async function AdminPage() {
  ...
  return <main className="admin-page"><div className="wrap">
    <div className="admin-heading"><div><div className="section-kicker">RUANG PENGELOLA</div><h1>Suara yang <em>terkumpul.</em></h1><p>Lihat kisah pendengar, umpan balik, dan pendaftaran sukarelawan yang tersimpan di situs ini.</p></div><form action={logout}><button type="submit" className="admin-logout">Keluar ↗</button></form></div>
