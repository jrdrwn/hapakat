...
export default async function ListenerPage() {
  ...
  return <main>
    <section className="page-hero listener-page-hero"><LivingBackdrop variant="river" /><div className="wrap"><div className="section-kicker">CERITA PENDENGAR / HAPAKAT</div><h1>Cerita hidup saat<br /><em>kita membagikannya.</em></h1><p>Punya kisah dari rumah, keluarga, atau daerahmu? Tulis dan biarkan orang lain ikut mengenal bahasa serta ingatan di dalamnya.</p><a className="button button-primary" href="#bagikan">Bagikan ceritamu <span aria-hidden="true"><ArrowIcon /></span></a></div></section>
